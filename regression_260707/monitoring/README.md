...
체크포인트 parity plot은 checkpoint state가 경로와 SHA-256을 함께 승인한 OOF
산출물만 읽는다. 손실 target의 구조적 0은 MAPE/P90 분모에서 제외하되 해당 행은
학습과 R²/RMSE에는 그대로 포함하며, 사용/제외 표본 수와 1e-9 허용치를 기록한다.
