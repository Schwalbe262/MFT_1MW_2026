...
$Controller = Join-Path $PSScriptRoot 'q23_same_node_campaign.py'
$LogDir = Join-Path $StateDir 'q23_logs'
New-Item -ItemType Directory -Path $LogDir -Force | Out-Null
$LogPath = Join-Path $LogDir 'q23_same_node_supervisor.log'
$Arguments = @(
    '-u', $Controller,
...
while ($true) {
    "[$(Get-Date -Format o)] starting q23 same-node controller" |
