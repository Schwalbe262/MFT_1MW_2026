"""Entrypoint for the fixed-N1=5 size/Rx/core Tier-1 island."""
...
VARIANT = "fixed-n1-5-size-rx-core-v1"
_existing = os.environ.get("MFT_TIER1_SEARCH_VARIANT")
if _existing not in {None, VARIANT}:
    raise RuntimeError(
        "MFT_TIER1_SEARCH_VARIANT conflicts with fixed-N1=5 size/Rx/core "
...
if (
    ...
    or rolling.FIXED_PRIMARY_TURNS != 5
    or rolling.SEARCH_FOCUS
    ...
    or rolling.SEED_START != 1_907_199_000
    ...
    or rolling.PRIORITY_MIGRATION_SEED_CUTOFF != 1_907_199_000
    or rolling.TASK_NAME_STEM != "mft-t1n5src"
    or rolling.DEDUPE_NAMESPACE
    != "mft-tier1-fixed-n1-5-size-rx-core-nsga"
