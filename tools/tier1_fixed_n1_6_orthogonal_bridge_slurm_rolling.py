"""Entrypoint for the fixed-N1=6 orthogonal thermal/Llt/resonance lane."""
...
VARIANT = "fixed-n1-6-orthogonal-bridge-v1"
_existing = os.environ.get("MFT_TIER1_SEARCH_VARIANT")
if _existing not in {None, VARIANT}:
    raise RuntimeError(
        "MFT_TIER1_SEARCH_VARIANT conflicts with fixed-N1=6 orthogonal "
...
if (
    ...
    or rolling.SEARCH_FOCUS != "orthogonal_thermal_llt_resonance_bridge"
    or rolling.OPTIMIZER_RESONANCE_SCALE_HZ != 150.0
    or rolling.OPTIMIZER_CORE_THERMAL_SCALE_C is not None
    or rolling.OPTIMIZER_LLT_SCALE_UH != 0.25
    or rolling.OPTIMIZER_ALL_THERMAL_SCALE_C != 2.0
    or rolling.SEED_START != 1_907_198_000
    or rolling.ROLLING_TARGET != 32
    or rolling.POPULATION != 320
    or rolling.MAX_GENERATIONS != 600
    or rolling.INFERENCE_THREADS != 8
    or rolling.TASK_PRIORITY != -1
    or rolling.LEGACY_TASK_PRIORITY != -2
    or rolling.PRIORITY_MIGRATION_SEED_CUTOFF != 1_907_198_000
    or rolling.TASK_NAME_STEM != "mft-t1n6ortho"
